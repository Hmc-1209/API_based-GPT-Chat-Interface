      ...
      <div className="h-dvh  flex flex-col items-center justify-center text-center">
        ...
        <div className="w-[90%] md:w-[80%] text-left min-h-[80%] text-[15px] xl:text-[20px] xl:min-h-[80%] overflow-y-auto text-justify">
          <div className="leading-6 xl:leading-8 mb-4 xl:mb-2">
            ...
            application built for people to use GPT with a pay as you go method.
            I made this application because I would like to use GPT 4o without
          ...
          <div className="leading-6 xl:leading-8 mb-4 xl:mb-2">
            ...
            questions just like ChatGPT website. Account passwords are stored
            with hash and each openai API key were encrypted with unique
            encrytption key. All chat records were encrypted on the server too.
            The application is hosted on Synology NAS DS923+.
          </div>
          <br />
          <div className="leading-6 xl:leading-8 mb-4 xl:mb-2">
            ...
            <ul>
              ...
              <li>
                &emsp;&#8226; Password were stored properly with hashing and
                each API key encrypted with unique encryption key.
              </li>
              <li>
                &emsp;&#8226; The chat record were also encrypted with
                encryption key.
              </li>
              <li>
                &emsp;&#8226; The account token is stored in the browser with
                HTTP only cookie and secure tag.
              </li>
            </ul>
          </div>
          <br />
          <div className="leading-6 xl:leading-8 mb-4 xl:mb-2">
            ...
            <ul>
              ...
              <li>
                &emsp;
                <i class="fa-solid fa-address-card" /> : User profile, for user
                to check the detail of the accont.
              </li>
              <li>
                &emsp;
          ...
          <div className="leading-6 xl:leading-8 mb-4 xl:mb-2">
            ...
            the given email:{" "}
            <span className="font-bold">dannyho1209@gmail.com</span>. Also,
            check out the original source code of this project{" "}
            <a
