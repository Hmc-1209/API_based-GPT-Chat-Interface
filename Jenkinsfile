            ...
            steps {
                sshagent(['SSH-dannyho']) {
                    withCredentials([file(credentialsId: "API_Based_GPT_Chat_Interface_db_config", variable: 'dbConfig'),
                        ...
                        sh '''
                        scp -o StrictHostKeyChecking=no -O $dbConfig dannyho@125.229.56.26:/volume1/homes/dannyho/deployments/API_based-GPT-Chat-Interface/db/apib_gptci-db-config.py
